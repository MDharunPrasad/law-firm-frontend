...
// Test import to verify all components load correctly
...
export default function TestApp() {
  ...
  useEffect(() => {
    // Simple initialization - no complex utilities
  ...
  const renderPage = () => {
    try {
      ...
      return pageComponents[currentPage as keyof typeof pageComponents] || pageComponents.home;
    } catch (error) {
